    ...
    fun getLocalizedName(languageCode: String): String {
        return when (languageCode) {
            "en" -> when (name) {
                ...
                "خيال اللافندر" -> "Lavender Fantasy"
                "السيبي دافئ" -> "Warm Sepia"
                "نسيم التيل" -> "Teal Breeze"
                "الوردي المرجاني" -> "Coral Pink"
                "إنديغو السيبراني" -> "Cyber Indigo"
                "الفحم الحجري" -> "Charcoal Slate"
                else -> name
            }
            "fr" -> when (name) {
                "الافتراضي" -> "Par défaut"
                "الأزرق الملكي" -> "Bleu Royal"
                "الأخضر الزمردي" -> "Vert Émeraude"
                "البرتقالي الدافئ" -> "Orange Chaud"
                "الأحمر القرمزي" -> "Rouge Cramoisi"
                "خيال اللافندر" -> "Lavande"
                "السيبي دافئ" -> "Sépia Chaud"
                "نسيم التيل" -> "Brise Sarcelle"
                "الوردي المرجاني" -> "Rose Corail"
                "إنديغو السيبراني" -> "Indigo Cyber"
                "الفحم الحجري" -> "Ardoise"
                else -> name
            }
            "de" -> when (name) {
                "الافتراضي" -> "Standard"
                "الأزرق الملكي" -> "Königsblau"
                "الأخضر الزمردي" -> "Smaragdgrün"
                "البرتقالي الدافئ" -> "Warmes Orange"
                "الأحمر القرمزي" -> "Karmesinrot"
                "خيال اللافندر" -> "Lavendel"
                "السيبي دافئ" -> "Warmes Sepia"
                "نسيم التيل" -> "Teal"
                "الوردي المرجاني" -> "Korallenrosa"
                "إنديغو السيبراني" -> "Cyber-Indigo"
                "الفحم الحجري" -> "Holzkohle"
                else -> name
            }
            "es" -> when (name) {
                "الافتراضي" -> "Predeterminado"
                "الأزرق الملكي" -> "Azul Real"
                "الأخضر الزمردي" -> "Verde Esmeralda"
                "البرتقالي الدافئ" -> "Naranja Cálido"
                "الأحمر القرمزي" -> "Rojo Carmesí"
                "خيال اللافندر" -> "Fantasía Lavanda"
                "السيبي دافئ" -> "Sepia Cálido"
                "نسيم التيل" -> "Brisa Teal"
                "الوردي المرجاني" -> "Rosa Coral"
                "إنديغو السيبراني" -> "Índigo Cyber"
                "الفحم الحجري" -> "Carbón"
                else -> name
            }
            "tr" -> when (name) {
                "الافتراضي" -> "Varsayılan"
                "الأزرق الملكي" -> "Kraliyet Mavi"
                "الأخضر الزمردي" -> "Zümrüt Yeşili"
                "البرتقالي الدافئ" -> "Sıcak Turuncu"
                "الأحمر القرمزي" -> "Koyu Kırmızı"
                "خيال اللافندر" -> "Lavanta"
                "السيبي دافئ" -> "Sıcak Sepya"
                "نسيم التيل" -> "Camgöbeği"
                "الوردي المرجاني" -> "Mercan Pembe"
                "إنديغو السيبراني" -> "Siber Çivit"
                "الفحم الحجري" -> "Kömür"
                else -> name
            }
            "ru" -> when (name) {
                "الافتراضي" -> "По умолчанию"
                "الأزرق الملكي" -> "Королевский синий"
                "الأخضر الزمردي" -> "Изумрудно-зеленый"
                "البرتقالي الدافئ" -> "Теплый оранжевый"
                "الأحمر القرمزي" -> "Малиново-красный"
                "خيال اللافندر" -> "Лаванда"
                "السيبي دافئ" -> "Теплая сепия"
                "نسيم التيل" -> "Морская волنا"
                "الوردي المرجاني" -> "Коралово-розовый"
                "إنديغو السيبراني" -> "Кибер-индиго"
                "الفحم الحجري" -> "Угольный"
                else -> name
            }
            else -> name
        }
